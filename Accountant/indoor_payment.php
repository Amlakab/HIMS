                            ...
                            include ('../db_connection.php');
                              ...
                              $seq_no=0;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update_status.php?id=<?php echo $row['Pid']; ?>&idddd=<?php echo $row['Id']; ?>&fname=<?php echo $row['Fname']; ?>&mname=<?php echo $row['Mname']; ?>&lname=<?php echo $row['Lname']; ?>&type=<?php echo $row['Intype']; ?>&day=<?php echo $row['Day']; ?>&price=<?php echo $row['Price']; ?>&role=indoor&payment=<?php echo $row['Payment']; ?>&payed=<?php echo $row['Payed']; ?>&unpayed=<?php echo $row['Unpayed']; ?>"><button class="btn btn-success"><?php echo $row['Payment']; ?></button></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
