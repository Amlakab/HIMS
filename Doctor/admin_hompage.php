            ...
            <section style="padding: 20px;">
                <div class="col-sm-3">
                    <div class="card card-green">
                        ...
                        <a href="doctor_treatment.php"><button class="btn-primary btn">View</button></a>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card card-yellow" >
                        ...
                        <a href="doctor_outpatient.php"><button class="btn-primary btn">View</button></a>
                    </div>
                </div>
                <div class="col-sm-3 " >
                    <div class="card card-blue" >
                        ...
                        <a href="doctor_admited.php"><button class="btn-primary btn">View</button></a>
                    </div>
                </div>
                <div class="col-sm-3" >
                    <div class="card card-red" >
                        ...
                        <a href="doctor_discharged.php"><button class="btn-primary btn">View</button></a>
                    </div>
                </div>
            </section>
          </div>
