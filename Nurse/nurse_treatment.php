...
<body>
                        ...
                        <tbody>
                            ...
                            include ('../db_connection.php');
                              ...
                              $seq_no=0;
                                ...
                                $seq_no++;
                                $id=$row['Id'];
                                $query="SELECT * FROM admited WHERE Id='$id' ";
                                $add=mysqli_query($con,$query);
                                if($rows=mysqli_fetch_assoc($add)){
                                $resoan=$rows['Resoan'];
                                $lstyle=$rows['Lstyle'];
                                $tplan=$rows['Tplan'];
                                }
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <td><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#registrationModal" onclick="openModal(' <?php echo $resoan ; ?> ',' <?php echo $lstyle ; ?> ',' <?php echo $tplan ; ?> ',' <?php echo $row['Ptype']; ?> ')">View</button>
                                    </td>
                                    <td>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#registrationModal2" onclick="openModal2(' <?php echo $id ; ?> ')">Allocate</button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody> 
                ...
                <div class="modal-body">
                    ...
                    <form id="registrationForm">
                        <div class="mb-3">
                            ...
                            <textarea style="width: 100% ; height: 180px" name="" disabled id="resoan"></textarea>
                        </div>
                        <div class="mb-3">
                        <h4 style="width: 100% ; height: 40px; background-color : black ; color: white; text-align: center; paddind-top:10px" >Username</h4>                            
                        <textarea style="width: 100% ; height: 180px" name="" disabled id="lstyle"></textarea>
                        </div>
                        <div class="mb-3">
                        <h4 style="width: 100% ; height: 40px; background-color : black ; color: white; text-align: center; paddind-top:10px" >Username</h4>                            
                        <textarea style="width: 100% ; height: 180px" name="" disabled id="tplan"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="loginPassword" class="form-label">Indoor Type</label>
                            <input type="text" name="type" disabled id="ptype" class="form-control">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="registrationModal2" tabindex="-1" aria-labelledby="registrationModalLabel2" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="loginForm" method="post">
                        ...
                        <select id="ward2" class="form-control" name="rnumber">
                        ...
                        <select id="ward3" class="form-control" name="bnumber">
                            <option value="104">104</option>
                            <option value="202">202</option>
                            <option value="23">23</option>
                            <option value="104">104</option>
        ...
        $date=$_POST['date'];
        $sql="UPDATE  admited SET Date='$date',Roomnumber='$rnumber',Bednumber='$bnumber' WHERE Id='$idd'";
        $result=mysqli_query($con,$sql);
        if($result){
        
        $status="admited";
        $sql="UPDATE  patients SET Status='$status' WHERE Id='$idd'";
    ...
    function openModal(resoan,lstyle,tplan,type) {
        // You can use AJAX or simply use the item ID for displaying content in the modal.
        document.getElementById('resoan').value=resoan;
        document.getElementById('lstyle').value=lstyle;
        document.getElementById('tplan').value=tplan;
