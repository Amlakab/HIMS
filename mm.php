    ...
    <script>
        ...
        document.querySelectorAll('.save-button').forEach(button => {
            button.addEventListener('click', function () {
                ...
                const specialization = row.querySelector('.specialization input').value;
                ...
                fetch('doctors.php', {
                    ...
                    body: `id=${id}&name=${encodeURIComponent(name)}&specialization=${encodeURIComponent(specialization)}&phone=${encodeURIComponent(phone)}`
                })
                ...
                .then(data => {
                    ...
                    row.querySelector('.specialization').textContent = specialization;
